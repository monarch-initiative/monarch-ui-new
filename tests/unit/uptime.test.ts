...
test("Help page renders uptimerobot statuses", async () => {
  ...
  // check that various statuses exist. fixture data contains all possible status types from uptimerobot. check that all of them get converted to and displayed as appropriate status components.
